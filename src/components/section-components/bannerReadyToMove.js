...
const BannerReadyToMove = ({ updateFilters }) => {
    ...
    const handleSearch = () => {
        ...
        console.log('Search Filters:', filters); // Log the search filters to the console
                                    ...
                                    <div className="slide-item-car-dealer-form">
                                        <div className="ltn__car-dealer-form-tab">
                                            <div className="ltn__tab-menu text-uppercase">
                                                <div className="nav">
                                                    <a
                                                        className={`show ${status === 'All' ? 'active' : ''}`}
                                                        onClick={() => setStatus('All')}
                                                    >
                                                        <i className="fas fa-list" /> All
                                                    </a>
                                                    <a
                                                        className={`show ${status === 'Rent' ? 'active' : ''}`}
                                                        onClick={() => setStatus('Rent')}
                                                    >
                                                        <i className="fas fa-key" /> Rent
                                                    </a>
                                                    <a
                                                        className={`show ${status === 'Buy' ? 'active' : ''}`}
...
export default BannerReadyToMove;