...
class BannerV6 extends Component {
						...
						<div className="col-lg-12 align-self-center">
							...
							<div className="ltn__car-dealer-form-tab">
								...
								<div className="nav">
									...
									<a data-bs-toggle="tab" href="#ltn__form_tab_1_2" className><i className="fas fa-home" />Ready To Move</a>
								</div>
								</div>
  ...
  <option>Jumeirah Lake Towers (JLT)</option>
  ...
  <option>Jumeirah Islands</option>
</select>

										</div> 
										<div className="ltn__car-dealer-form-item ltn__custom-icon ltn__icon-calendar col-lg-3 col-md-6">
										<select className="nice-select">
											<option>Bedrooms Number</option>
